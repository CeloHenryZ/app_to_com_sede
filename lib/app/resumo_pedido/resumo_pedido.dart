...
import 'package:loja_tocomsede/app/pdf/pdf_view.dart';
import 'package:loja_tocomsede/app/providers/itens_pedido_list.dart';
import 'package:loja_tocomsede/app/widgets/cardResumo.dart';
import 'package:loja_tocomsede/app/widgets/colors.dart';
import 'package:loja_tocomsede/database/database.dart';
                                        ...
                                        child: Container(
                                          ...
                                          child: GestureDetector(
                                            ...
                                            onTap: () async {
                                              ...
                                              try {
                                                await launch(
                                                    'https://api.whatsapp.com/send?phone=5588988417290');
                                              } catch (error) {
                                                print(error);
                                              }
                                            },
